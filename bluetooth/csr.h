...
#define CSR_PHYS_BUS_NONE			0x0000
#define CSR_PHYS_BUS_BCSP			0x0001
#define CSR_PHYS_BUS_USB			0x0002
#define CSR_PHYS_BUS_H4				0x0003
#define CSR_PHYS_BUS_USR			0x0004	/* vm */
#define CSR_PHYS_BUS_H5				0x0006
#define CSR_PHYS_BUS_H4DS			0x0007

#define CSR_STATUS_OK				0x0000	/* Default; no problem found. */
#define CSR_STATUS_NO_SUCH_VARID	0x0001 /* Variable identifier not recognised. */
#define CSR_STATUS_TOO_BIG			0x0002	/* Data exceeded message or memory capacity. */
#define CSR_STATUS_NO_VALUE			0x0003 /*Variable has no value. */
#define CSR_STATUS_BAD_REQ			0x0004 /* GETREQ or SETREQ held an error. */
#define CSR_STATUS_NO_ACCESS		0x0005 /* Value of variable inaccessible. */
#define CSR_STATUS_READ_ONLY		0x0006 /* Value of variable unwritable. */
#define CSR_STATUS_WRITE_ONLY		0x0007 /* Value of variable unreadable. */
#define CSR_STATUS_ERROR			0x0008 /* Other error.*/
#define CSR_STATUS_PERMISSION_DENIED 0x0009 /*Request not allowed.  */
