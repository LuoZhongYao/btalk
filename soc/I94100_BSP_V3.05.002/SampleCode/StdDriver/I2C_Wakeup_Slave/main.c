...
void I2C_SlaveTRx(uint32_t u32Status)
{
                                                   ...
                                                   Data has been received; ACK has been returned*/
    {
      ...
      u8Temp = (unsigned char)I2C_GET_DATA(I2C0);
...
int32_t main(void)
{
    ...
    */
    printf("\n");
    printf("+-----------------------------------------------------------------------+\n");
    printf("| I94100 I2C Driver Sample Code (Slave) for wake-up & access Slave test |\n");
    printf("|                                                                       |\n");
    ...
    printf("I2C0_SDA(PA.9), I2C0_SCL(PA.10)\n");
    ...
    SYS_LockReg();
		...
		// Clear wake-up done register to release I2C bus from holding. 
