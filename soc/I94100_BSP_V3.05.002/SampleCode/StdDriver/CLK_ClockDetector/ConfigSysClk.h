...
/**
  ...
  * SYSCLK_HCLK_CLK_PLL_HXT  : HCLK's clock source is from PLL, and PLL's clock source is from HXT.
	* @note
	* The PCLK0 and PCLK1 frequency can not be greater than 100MHz.
	* If the HCLK clock setting is greater than 100MHz, the PCLKDIV0 and PCLKDIV1
	* will be set to meet the limitation in SysClk_Initiate().
  */	
