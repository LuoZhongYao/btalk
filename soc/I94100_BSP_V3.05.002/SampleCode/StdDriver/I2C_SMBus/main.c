...
void I2C_MasterAlert(uint32_t u32Status)
{
    ...
    {
      uint8_t u8Temp = I2C_GET_DATA(I2C0);
      
        if(g_u8DataLen0 == 0)
        {
            g_au8RxData[g_u8DataLen0] = u8Temp;
            I2C_SET_CONTROL_REG(I2C0, I2C_CTL_SI_AA);
            g_u8DataLen0++;
        }
        else
...
void I2C_SlaveTRx(uint32_t u32Status)
{
                                                   ...
                                                   Data has been received; ACK has been returned*/
    {
      ...
      u8Temp = g_u8DataLen1;
        g_au8RxData[u8Temp] = (unsigned char)I2C_GET_DATA(I2C1);
        g_u8DataLen1++;

        if(g_u8DataLen1 == 2)
        {
          u8Temp = (g_au8RxData[0] << 8) ;
            slave_buff_addr = u8Temp + g_au8RxData[1];
        }
        if(g_u8DataLen1 == 3)
        {
          u8Temp = g_au8RxData[2];
            g_u8SlvData[slave_buff_addr] = u8Temp;
        }
        if(g_u8DataLen1 == 4)
        {
...
void I2C_SlaveDefaultAddrACKM(uint32_t u32Status)
{
  uint8_t u8Temp;
    ...
    else if(u32Status == 0xF0)
    {
      ...
      u8Temp = I2C_GET_DATA(I2C1);
        g_au8RxData[g_u8DataLen1] = u8Temp ;
        g_u8DataLen1++;
        ...
        I2C_SET_CONTROL_REG(I2C1, I2C_CTL_SI_AA);           //Acknowledge by Manual
                                                   ...
                                                   Data has been received; ACK has been returned*/
    {
      u8Temp = (unsigned char) I2C_GET_DATA(I2C1);
        g_au8RxData[g_u8DataLen1] = u8Temp;
        g_u8DataLen1++;
...
void I2C0_Init(void)
{
	...
	SYS->GPA_MFPH = (SYS->GPA_MFPH & ~(SYS_GPA_MFPH_PA9MFP_Msk | SYS_GPA_MFPH_PA10MFP_Msk | SYS_GPA_MFPH_PA11MFP_Msk | SYS_GPA_MFPH_PA12MFP_Msk)) | 
	(SYS_GPA_MFPH_PA9MFP_I2C0_SCL | SYS_GPA_MFPH_PA10MFP_I2C0_SDA | SYS_GPA_MFPH_PA12MFP_I2C0_SMBAL | SYS_GPA_MFPH_PA11MFP_I2C0_SMBSUS );
...
void I2C1_Init(void)
{
	...
	(SYS_GPC_MFPL_PC0MFP_I2C1_SCL | SYS_GPC_MFPL_PC1MFP_I2C1_SDA | SYS_GPC_MFPL_PC2MFP_I2C1_SMBSUS | SYS_GPC_MFPL_PC3MFP_I2C1_SMBAL);
