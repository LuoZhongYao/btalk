 ...
 * @version  V1.00
 * $Revision: 1 $
 * $Date: 17/03/27 10:00a $
 * @brief    I94100 series I2C driver header file
 *
 * @note
...
/** @addtogroup I94100_I2C_Driver I2C Driver
  @{
*/

/** @addtogroup I94100_I2C_EXPORTED_CONSTANTS I2C Exported Constants
  @{
*/
...
/*@}*/ /* end of group I94100_I2C_EXPORTED_CONSTANTS */

/** @addtogroup I94100_I2C_EXPORTED_FUNCTIONS I2C Exported Functions
  @{
*/
/**
...
/**
 *    @brief        To clear wake-up done register
 *
 *    @param[in]    i2c     Specify I2C port
 *
 *    @return       None
 *
 *    @details      If wake-up address fram ACK bit cycle is done, use this marco to free SCL.
 */
...
/*@}*/ /* end of group I94100_I2C_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group I94100_I2C_Driver */
