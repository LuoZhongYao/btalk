...
/** @addtogroup I94100_USBD_EXPORTED_STRUCTS USBD Exported Structs
  @{
*/
typedef struct s_usbd_info
{
	...
	const uint8_t *gu8QualiferDesc;		/*!< Pointer for USB Device Qualifier Descriptor> */
} S_USBD_INFO_T;

extern const S_USBD_INFO_T gsInfo;

/*@}*/ /* end of group I94100_USBD_EXPORTED_STRUCTS */




/** @addtogroup I94100_USBD_EXPORTED_CONSTANTS USBD Exported Constants
  @{
*/
...
#define USBD_INT_SOF            USBD_INTEN_SOFIEN_Msk       /*!< USB Start Of Frmae Interrupt */
...
/*@}*/ /* end of group I94100_USBD_EXPORTED_CONSTANTS */
...
/**
  ...
  *
  * @param[in]  ep The USB endpoint ID. I94100 Series supports 12 hardware endpoint ID. This parameter could be 0 ~ 7.
  *
  * @return     None
  *
...
/**
  ...
  *
  * @param[in]  ep The USB endpoint ID. I94100 Series supports 12 endpoint ID. This parameter could be 0 ~ 7.
  *
