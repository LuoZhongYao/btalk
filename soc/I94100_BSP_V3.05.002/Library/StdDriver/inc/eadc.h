 ...
 * @brief    I94100 series EADC driver header file
 *
...
/** @addtogroup I94100_EADC_Driver EADC Driver
  @{
*/

/** @addtogroup I94100_EADC_EXPORTED_CONSTANTS EADC Exported Constants
  @{
*/
...
/*---------------------------------------------------------------------------------------------------------*/
#define EADC_CTL_DIFFEN_SINGLE_END          (0UL)   /*!< Single-end input mode      */
#define EADC_CTL_DIFFEN_DIFFERENTIAL        (0UL)   /*!< Differential input mode    */
...
#define EADC_SCTL_INT_END_FLAG				(0UL<<EADC_SCTL_INTPOS_Pos)		 /*!< ADIFn (EADC_STATUS2[n], n=0~3) interrupts occur at ADC end of conversion. */
#define EADC_SCTL_INT_START_FLAG			(1UL<<EADC_SCTL_INTPOS_Pos) 	 /*!< ADIFn (EADC_STATUS2[n], n=0~3) interrupts occur at ADC start of conversion. */
...
/*@}*/ /* end of group I94100_EADC_EXPORTED_CONSTANTS */

/** @addtogroup I94100_EADC_EXPORTED_FUNCTIONS EADC Exported Functions
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
...
/**
  * @brief Set ADIFn interrupt position.
  * @param[in] eadc The pointer of the specified EADC module.
  * @param[in] u32ModuleNum Decides the sample module number, valid value are from 0 to 15.
  * @param[in] u32IntPosition Decides interrupt Flag Position:
  *            - \ref EADC_SCTL_INT_END_FLAG     
  *            - \ref EADC_SCTL_INT_START_FLAG     
  * @return None
  * @details The A/D converter generates ADIFn (EADC_STATUS2[3:0], n=0~3) at the end or start of conversion.
  */
#define EADC_SET_INT_POSITION(eadc, u32ModuleNum, u32IntPosition) (((eadc)->SCTL[(u32ModuleNum)] = ((eadc)->SCTL[(u32ModuleNum)] &= ~EADC_SCTL_INTPOS_Msk) | u32IntPosition))
...
/**
  ...
  *                          This parameter decides which sample module interrupts will be enabled, valid range are between bit 0 ~ bit 12.
  * @return None
...
/**
  ...
  * @param[in] u32IntSel Decides which interrupt source will be used, valid value are from 0 to 3.
  * @param[in] u32ModuleMask the combination of sample module interrupt status bits. Each bit corresponds to a sample module interrupt status.
  *                          This parameter decides which sample module interrupts will be disabled, valid range are between bit 0 ~ bit 12.
  * @return None
  * @details There are 4 ADC interrupts ADINT0~3, and each of these interrupts has its own interrupt vector address.
  */
...
/**
  ...
  *                         This parameter decides which sample module will be conversion, valid range are between bit 0 ~ bit 12.
  *                         Bit 0 is sample module 0, bit 1 is sample module 1..., bit 12 is sample module 17.
  * @return None
...
/**
  ...
  * @param[in] eadc The pointer of the specified EADC module.
  * @param[in] u32ModuleMask The combination of sample module. Each bit corresponds to a sample module.
  *                         This parameter decides which sample module will stop the conversion, valid range are between bit 0 ~ bit 12.
  *                         Bit 0 is sample module 0, bit 1 is sample module 1..., bit 12 is sample module17.
  * @return None
...
/**
  ...
  * @details This STPFn(EADC_PENDSTS[17:0]) bit remains 1 during pending state, when the respective ADC conversion is end,
  *         the STPFn (n=0~17) bit is automatically cleared to 0.
  */
...
/**
  ...
  * @param[in] eadc The pointer of the specified EADC module.
  * @param[in] u32ModuleNum Decides the sample module number, valid value are from 0 to 17.
  * @return Return the conversion data of the user-specified sample module.
  * @details This macro is used to read RESULT bit (EADC_DATn[15:0], n=0~17) field to get conversion data.
  */
...
/**
  ...
  * @details The OV bit is mirrored to (EADC_STATUS0[31:16]) field.
  */
#define EADC_GET_DATA_OVERRUN_FLAG(eadc, u32ModuleNum) ((eadc)->DAT[(u32ModuleNum)] & EADC_DAT_OV_Msk)
...
/**
  ...
  * @details The VALID bit is mirrored to (EADC_STATUS0[15:0]) field 
  */
#define EADC_GET_DATA_VALID_FLAG(eadc, u32ModuleNum) ((eadc)->DAT[(u32ModuleNum)] & EADC_DAT_VALID_Msk)
...
/**
  ...
  *            - \ref EADC_STATUS2_ADIF0_Msk     
  *            - \ref EADC_STATUS2_ADIF1_Msk     
  *            - \ref EADC_STATUS2_ADIF2_Msk
  *            - \ref EADC_STATUS2_ADIF3_Msk
  *            - \ref EADC_STATUS2_ADCMPF0_Msk
  *            - \ref EADC_STATUS2_ADCMPF1_Msk
  *            - \ref EADC_STATUS2_ADCMPF2_Msk
  *            - \ref EADC_STATUS2_ADCMPF3_Msk
  *            - \ref EADC_STATUS2_ADOVIF0_Msk
  *            - \ref EADC_STATUS2_ADOVIF1_Msk
  *            - \ref EADC_STATUS2_ADOVIF2_Msk
  *            - \ref EADC_STATUS2_ADOVIF3_Msk
...
/**
  ...
  * @param[in] eadc The pointer of the specified EADC module.
  * @param[in] u32ModuleMask The combination of sample module overrun status bits. Each bit corresponds to a sample module overrun status, valid range are between bit 0 ~ bit 12.
...
/**
  ...
  *                      Bit 0 is SPOVF0, bit 1 is SPOVF1..., bit 12 is SPOVF18.
  * @return None
...
/**
  ...
  * @param[in] eadc The pointer of the specified EADC module.
  * @param[in] u32ModuleNum specifies the compare sample module, valid value are from 0 to 17.
  ...
  * @return None
  * @details For example, ADC_ENABLE_CMP0(EADC, 5, ADC_ADCMPR_CMPCOND_GREATER_OR_EQUAL, 0x800, 10);
...
/**
  ...
  * @param[in] u32MatchCount specifies the match count setting, valid range are between 0~0xF.
  * @return None
  * @details For example, ADC_ENABLE_CMP1(EADC, 5, ADC_ADCMPR_CMPCOND_GREATER_OR_EQUAL, 0x800, 10);
...
/**
  ...
  * @param[in] u32MatchCount specifies the match count setting, valid range are between 0~0xF.
  * @return None
  * @details For example, ADC_ENABLE_CMP2(EADC, 5, ADC_ADCMPR_CMPCOND_GREATER_OR_EQUAL, 0x800, 10);
...
/**
  ...
  * @return None
  * @details For example, ADC_ENABLE_CMP3(EADC, 5, ADC_ADCMPR_CMPCOND_GREATER_OR_EQUAL, 0x800, 10);
...
/*@}*/ /* end of group I94100_EADC_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group I94100_EADC_Driver */

/*@}*/ /* end of group I94100_Device_Drive */
