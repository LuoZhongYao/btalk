 ...
 * @brief    I94100 series EADC driver source file
 *
...
/**
  ...
  * @param[in] u32InputMode non used.
  * @return None
...
/**
  ...
  * @param[in] u32Channel Specifies the sample module channel, valid value are from 0 to 12.
  * @return None
  * @details Each of ADC control logic modules 0~12 which is configurable for ADC converter channel EADC_CH0~12 and trigger source.
  *         sample module 16~17 is fixed for ADC channel 16, 17 input sources as band-gap voltage, temperature sensor.
  */
...
/**
  ...
  * @param[in] eadc The pointer of the specified EADC module.
  * @param[in] u32ModuleNum Decides the sample module number, valid value are from 0 to 12.
  ...
  * @return None
  * @details User can configure the trigger delay time by setting TRGDLYCNT (EADC_SCTLn[15:8], n=0~12) and TRGDLYDIV (EADC_SCTLn[7:6], n=0~12).
