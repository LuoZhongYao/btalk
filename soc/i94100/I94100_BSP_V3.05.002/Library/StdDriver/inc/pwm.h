 ...
 * @brief    I94100 series PWM driver header file
 *
 * @note
...
/** @addtogroup I94100_PWM_Driver PWM Driver
  @{
*/

/** @addtogroup I94100_PWM_EXPORTED_CONSTANTS PWM Exported Constants
  @{
*/
...
/*---------------------------------------------------------------------------------------------------------*/
/*  Complementary Output Mode Constant Definitions                                                               */
/*---------------------------------------------------------------------------------------------------------*/
#define PWM_CHAN0_COMP_OUTPUT                    (PWM_CTL1_OUTMODE0_Msk)    /*!< PWM Channel0 Complementary \hideinitializer */
#define PWM_CHAN2_COMP_OUTPUT                    (PWM_CTL1_OUTMODE2_Msk)    /*!< PWM Channel0 Complementary \hideinitializer */
#define PWM_CHAN4_COMP_OUTPUT                    (PWM_CTL1_OUTMODE4_Msk)    /*!< PWM Channel0 Complementary \hideinitializer */

/*@}*/ /* end of group I94100_PWM_EXPORTED_CONSTANTS */


/** @addtogroup I94100_PWM_EXPORTED_FUNCTIONS PWM Exported Functions
  @{
*/
 ...
 * @param[in] u32Mask
			- \ref PWM_CHAN0_COMP_OUTPUT
			- \ref PWM_CHAN2_COMP_OUTPUT
			- \ref PWM_CHAN4_COMP_OUTPUT
 * @return None
 * @details This macro is used to enable complementary mode of PWM module.
 * \hideinitializer
 */
#define PWM_ENABLE_COMPLEMENTARY_CHAN_MODE(pwm, u32Mask) ((pwm)->CTL1 = (pwm)->CTL1 | u32Mask)

/**
 * @brief This macro disable complementary mode
 * @param[in] pwm The pointer of the specified PWM module
 * @param[in] u32Mask
			- \ref PWM_CHAN0_COMP_OUTPUT
			- \ref PWM_CHAN2_COMP_OUTPUT
 ...
 * \hideinitializer
 */
#define PWM_DISABLE_COMPLEMENTARY_CHAN_MODE(pwm, u32Mask) ((pwm)->CTL1 = (pwm)->CTL1 & ~u32Mask)
...
/**
 * @brief Get counter of specified channel
 * @param[in] pwm The pointer of the specified PWM module
 * @param[in] u32ChannelNum PWM channel number. Valid values are between 0~5
 * @return Counter value
 * @details This macro is used to get counter of specified channel.
 * \hideinitializer
 */
#define PWM_GET_COUNTER(pwm, u32ChannelNum) ((pwm)->CNT[u32ChannelNum] & PWM_CNT_CNT_Msk)
...
void PWM_EnableRisingCaptureReload(PWM_T *pwm, uint32_t u32ChannelMask);
void PWM_DisableRisingCaptureReload(PWM_T *pwm, uint32_t u32ChannelMask);
void PWM_EnableFallingCaptureReload(PWM_T *pwm, uint32_t u32ChannelMask);
void PWM_DisableFallingCaptureReload(PWM_T *pwm, uint32_t u32ChannelMask);
...
/*@}*/ /* end of group I94100_PWM_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group I94100_PWM_Driver */
