...
#define SYS_GPA_MFPL_PA0MFP_EADC0_CH0           (0x02UL<<SYS_GPA_MFPL_PA0MFP_Pos) /* EADC0 channel0 analog input. */
#define SYS_GPA_MFPL_PA0MFP_DMIC_DAT0           (0x03UL<<SYS_GPA_MFPL_PA0MFP_Pos) /* Digital microphone channel 0 data input pin. */
...
#define SYS_GPA_MFPL_PA1MFP_EADC0_CH1           (0x02UL<<SYS_GPA_MFPL_PA1MFP_Pos) /* EADC0 channel1 analog input. */
#define SYS_GPA_MFPL_PA1MFP_DMIC_CLK0           (0x03UL<<SYS_GPA_MFPL_PA1MFP_Pos) /* Digital microphone channel 0 clock output pin. */
...
#define SYS_GPA_MFPL_PA2MFP_EADC0_CH2           (0x02UL<<SYS_GPA_MFPL_PA2MFP_Pos) /* EADC0 channel2 analog input. */ 
#define SYS_GPA_MFPL_PA2MFP_DMIC_DAT1           (0x03UL<<SYS_GPA_MFPL_PA2MFP_Pos) /* Digital microphone channel 1 data input pin. */ 
...
#define SYS_GPA_MFPL_PA3MFP_EADC0_CH3           (0x02UL<<SYS_GPA_MFPL_PA3MFP_Pos) /* EADC0 channel3 analog input. */ 
#define SYS_GPA_MFPL_PA3MFP_DMIC_CLK1           (0x03UL<<SYS_GPA_MFPL_PA3MFP_Pos) /* Digital microphone channel 1 clock output pin. */ 
...
#define SYS_GPA_MFPL_PA4MFP_EADC0_CH4           (0x02UL<<SYS_GPA_MFPL_PA4MFP_Pos) /* EADC0 channel4 analog input. */ 
#define SYS_GPA_MFPL_PA4MFP_DPWM_LN	            (0x03UL<<SYS_GPA_MFPL_PA4MFP_Pos) /* Audio DPWM left channel negative output pin. */ 
...
#define SYS_GPA_MFPL_PA5MFP_EADC0_CH5           (0x02UL<<SYS_GPA_MFPL_PA5MFP_Pos) /* EADC0 channel5 analog input. */ 
#define SYS_GPA_MFPL_PA5MFP_DPWM_LP	            (0x03UL<<SYS_GPA_MFPL_PA5MFP_Pos) /* Audio DPWM left channel positive output pin. */ 
...
#define SYS_GPA_MFPL_PA6MFP_EADC0_CH6           (0x02UL<<SYS_GPA_MFPL_PA6MFP_Pos) /* EADC0 channel6 analog input. */ 
...
#define SYS_GPA_MFPL_PA7MFP_EADC0_CH7           (0x02UL<<SYS_GPA_MFPL_PA7MFP_Pos) /* EADC0 channel7 analog input. */ 
#define SYS_GPA_MFPL_PA7MFP_SPI2I2S_DI          (0x04UL<<SYS_GPA_MFPL_PA7MFP_Pos) /* SPI2 MISO (Master In, Slave Out) pin; or I2S2 data input pin. */ 
#define SYS_GPA_MFPL_PA7MFP_SPI2_MISO           (0x04UL<<SYS_GPA_MFPL_PA7MFP_Pos) /* SPI2 MISO (Master In, Slave Out) pin; or I2S2 data input pin. */ 
...
#define SYS_GPA_MFPH_PA8MFP_EADC0_CH8           (0x02UL<<SYS_GPA_MFPH_PA8MFP_Pos) /* EADC0 channel8 analog input. */ 
#define SYS_GPA_MFPH_PA8MFP_SPI2I2S_DO          (0x04UL<<SYS_GPA_MFPH_PA8MFP_Pos) /* SPI2 MOSI (Master Out, Slave In) pin; or I2S2 data output pin. */ 
#define SYS_GPA_MFPH_PA8MFP_SPI2_MOSI           (0x04UL<<SYS_GPA_MFPH_PA8MFP_Pos) /* SPI2 MOSI (Master Out, Slave In) pin; or I2S2 data output pin. */ 
...
#define SYS_GPA_MFPH_PA9MFP_EADC0_CH9           (0x02UL<<SYS_GPA_MFPH_PA9MFP_Pos) /* EADC0 channel9 analog input. */
#define SYS_GPA_MFPH_PA9MFP_SPI2I2S_LRCK        (0x04UL<<SYS_GPA_MFPH_PA9MFP_Pos) /* SPI2 slave select pin; or I2S2 left right channel clock pin. */ 
#define SYS_GPA_MFPH_PA9MFP_SPI2_SS             (0x04UL<<SYS_GPA_MFPH_PA9MFP_Pos) /* SPI2 slave select pin; or I2S2 left right channel clock pin. */ 
...
#define SYS_GPA_MFPH_PA10MFP_EADC0_ST           (0x02UL<<SYS_GPA_MFPH_PA10MFP_Pos) /* EADC0 external trigger input. */ 
#define SYS_GPA_MFPH_PA10MFP_DPWM_RN            (0x03UL<<SYS_GPA_MFPH_PA10MFP_Pos) /* Audio DPWM right channel negative output pin. */ 
#define SYS_GPA_MFPH_PA10MFP_SPI2I2S_BCLK       (0x04UL<<SYS_GPA_MFPH_PA10MFP_Pos) /* SPI2 clock pin; or I2S2 bit clock pin. */ 
#define SYS_GPA_MFPH_PA10MFP_SPI2_CLK           (0x04UL<<SYS_GPA_MFPH_PA10MFP_Pos) /* SPI2 clock pin; or I2S2 bit clock pin. */ 

//GPA_MFPH_PA11MFP
#define SYS_GPA_MFPH_PA11MFP_GPIO               (0x00UL<<SYS_GPA_MFPH_PA11MFP_Pos) /* General purpose digital I/O pin. */ 
#define SYS_GPA_MFPH_PA11MFP_I2C0_SMBSUS        (0x01UL<<SYS_GPA_MFPH_PA11MFP_Pos) /* I2C0 SMBus SMBSUS# pin (PMBus CONTROL pin) */ 
#define SYS_GPA_MFPH_PA11MFP_T0                 (0x02UL<<SYS_GPA_MFPH_PA11MFP_Pos) /* Timer0 event counter input / toggle output. */ 
#define SYS_GPA_MFPH_PA11MFP_DPWM_RP            (0x03UL<<SYS_GPA_MFPH_PA11MFP_Pos) /* Audio DPWM right channel positive output pin. */ 

//GPA_MFPH_PA12MFP
#define SYS_GPA_MFPH_PA12MFP_GPIO               (0x00UL<<SYS_GPA_MFPH_PA12MFP_Pos) /* General purpose digital I/O pin. */ 
#define SYS_GPA_MFPH_PA12MFP_I2C0_SMBAL         (0x01UL<<SYS_GPA_MFPH_PA12MFP_Pos) /* I2C0 SMBus SMBALERT# pin */ 
#define SYS_GPA_MFPH_PA12MFP_T0_EXT             (0x02UL<<SYS_GPA_MFPH_PA12MFP_Pos) /* Timer0 external capture input. */
#define SYS_GPA_MFPH_PA12MFP_SPI2I2S_MCLK       (0x04UL<<SYS_GPA_MFPH_PA12MFP_Pos) /* SPI2 I2S master clock output pin. */
...
#define SYS_GPA_MFPH_PA13MFP_DPWM_SN            (0x03UL<<SYS_GPA_MFPH_PA13MFP_Pos) /* Audio DPWM sub-woofer channel negative output pin. */
#define SYS_GPA_MFPH_PA13MFP_I2C1_SCL           (0x04UL<<SYS_GPA_MFPH_PA13MFP_Pos) /* I2C1 clock pin. */ 
...
#define SYS_GPA_MFPH_PA14MFP_T1                 (0x02UL<<SYS_GPA_MFPH_PA14MFP_Pos) /* Timer1 event counter input / toggle output. */ 
#define SYS_GPA_MFPH_PA14MFP_DPWM_SP            (0x03UL<<SYS_GPA_MFPH_PA14MFP_Pos) /* Audio DPWM sub-woofer channel positive output pin. */ 
#define SYS_GPA_MFPH_PA14MFP_I2C1_SDA           (0x04UL<<SYS_GPA_MFPH_PA14MFP_Pos) /* I2C1 data input/output pin. */ 
...
#define SYS_GPB_MFPL_PB0MFP_PWM0_CH0            (0x03UL<<SYS_GPB_MFPL_PB0MFP_Pos) /* PWM0 channel0 output/capture input. */ 
...
#define SYS_GPB_MFPL_PB1MFP_PWM0_CH1            (0x03UL<<SYS_GPB_MFPL_PB1MFP_Pos) /* PWM0 channel1 output/capture input. */ 

//GPB_MFPL_PB2MFP
#define SYS_GPB_MFPL_PB2MFP_GPIO                (0x00UL<<SYS_GPB_MFPL_PB2MFP_Pos) /* General purpose digital I/O pin. */ 
#define SYS_GPB_MFPL_PB2MFP_PWM0_CH0            (0x01UL<<SYS_GPB_MFPL_PB2MFP_Pos) /* PWM0 channel0 output/capture input */ 
#define SYS_GPB_MFPL_PB2MFP_T2                  (0x02UL<<SYS_GPB_MFPL_PB2MFP_Pos) /* Timer2 event counter input / toggle output. */ 
#define SYS_GPB_MFPL_PB2MFP_PWM0_CH2            (0x03UL<<SYS_GPB_MFPL_PB2MFP_Pos) /* PWM0 channel2 output/capture input */ 
...
#define SYS_GPB_MFPL_PB3MFP_UART_RXD            (0x04UL<<SYS_GPB_MFPL_PB3MFP_Pos) /* UART0 Data receiver input pin. */
#define SYS_GPB_MFPL_PB3MFP_PWM0_CH3            (0x05UL<<SYS_GPB_MFPL_PB3MFP_Pos) /* PWM0 channel3 output/capture input. */
...
#define SYS_GPB_MFPL_PB4MFP_UART0_TXD           (0x04UL<<SYS_GPB_MFPL_PB4MFP_Pos) /* UART0 data transmitter output pin. */
#define SYS_GPB_MFPL_PB4MFP_PWM0_CH4            (0x05UL<<SYS_GPB_MFPL_PB4MFP_Pos) /* PWM0 channel4 output/capture input. */
...
#define SYS_GPB_MFPL_PB5MFP_I20_SDA             (0x03UL<<SYS_GPB_MFPL_PB5MFP_Pos) /* PWM0 channel1 output/capture input. */ 
#define SYS_GPB_MFPL_PB5MFP_I2C1_SDA            (0x04UL<<SYS_GPB_MFPL_PB5MFP_Pos) /* I2C1 data input/output pin. */
...
#define SYS_GPB_MFPL_PB6MFP_I2C0_SCL            (0x03UL<<SYS_GPB_MFPL_PB6MFP_Pos) /* I2C0 serial clock pin. */
#define SYS_GPB_MFPL_PB6MFP_I2C1_SCL            (0x04UL<<SYS_GPB_MFPL_PB6MFP_Pos) /* I2C1 serial clock pin. */
...
#define SYS_GPB_MFPH_PB13MFP_USBD_DP            (0x01UL<<SYS_GPB_MFPH_PB13MFP_Pos) /* USBD D+ pin */ 
...
#define SYS_GPB_MFPH_PB14MFP_USBD_DN            (0x01UL<<SYS_GPB_MFPH_PB14MFP_Pos) /* USBD D- pin */ 
...
#define SYS_GPC_MFPL_PC2MFP_T3                  (0x02UL<<SYS_GPC_MFPL_PC2MFP_Pos) /* Timer3 event counter input / toggle output. */ 
...
#define SYS_GPC_MFPL_PC3MFP_I2C1_SMBAL          (0x01UL<<SYS_GPC_MFPL_PC3MFP_Pos) /* I2C1 SMBus SMBALERT# pin */ 
...
#define SYS_GPC_MFPH_PC10MFP_PWM0_BRAKE0        (0x02UL<<SYS_GPC_MFPH_PC10MFP_Pos) /* Brake input pin 0 of PWM0. */ 
...
#define SYS_GPC_MFPH_PC11MFP_PWM0_BRAKE1        (0x02UL<<SYS_GPC_MFPH_PC11MFP_Pos) /* Brake input pin 1 of PWM0. */ 
...
#define SYS_GPC_MFPH_PC14MFP_DPWM_SN            (0x03UL<<SYS_GPC_MFPH_PC14MFP_Pos) /* Audio DPWM sub-woofer channel negative output pin. */ 
...
#define SYS_GPD_MFPL_PD0MFP_I2C0_SCL            (0x03UL<<SYS_GPD_MFPL_PD0MFP_Pos) /* I2C0 clock pin. */ 
#define SYS_GPD_MFPL_PD0MFP_I2S0_BCLK           (0x04UL<<SYS_GPD_MFPL_PD0MFP_Pos) /* I2S0 bit clock pin. */ 
#define SYS_GPD_MFPL_PD0MFP_DPWM1_N             (0x05UL<<SYS_GPD_MFPL_PD0MFP_Pos) /* Audio DPWM left channel negative output pin. */ 
...
#define SYS_GPD_MFPL_PD1MFP_I2C0_SDA            (0x03UL<<SYS_GPD_MFPL_PD1MFP_Pos) /* I2C0 data input/output pin. */ 
#define SYS_GPD_MFPL_PD1MFP_I2S0_LRCK           (0x04UL<<SYS_GPD_MFPL_PD1MFP_Pos) /* I2S0 left right channel clock pin. */ 
#define SYS_GPD_MFPL_PD1MFP_DPWM1_P             (0x05UL<<SYS_GPD_MFPL_PD1MFP_Pos) /* Audio DPWM left channel positive output pin. */ 
...
#define SYS_GPD_MFPL_PD2MFP_I2S0_MCLK           (0x03UL<<SYS_GPD_MFPL_PD2MFP_Pos) /* 2S0 master clock output pin. */ 
#define SYS_GPD_MFPL_PD2MFP_I2C1_SCL            (0x04UL<<SYS_GPD_MFPL_PD2MFP_Pos) /* I2C1 clock pin. */ 
#define SYS_GPD_MFPL_PD2MFP_TIM0                (0x05UL<<SYS_GPD_MFPL_PD2MFP_Pos) /* Timer0 event counter input / toggle output. */ 
...
#define SYS_GPD_MFPL_PD3MFP_I2S0_LRCK           (0x03UL<<SYS_GPD_MFPL_PD3MFP_Pos) /* I2S0 left right channel clock pin. */ 
#define SYS_GPD_MFPL_PD3MFP_DMIC_CLK1           (0x04UL<<SYS_GPD_MFPL_PD3MFP_Pos) /* Digital microphone channel 1 clock output pin. */ 
#define SYS_GPD_MFPL_PD3MFP_TIM2                (0x05UL<<SYS_GPD_MFPL_PD3MFP_Pos) /* Timer2 event counter input / toggle output. */ 
...
#define SYS_GPD_MFPL_PD4MFP_I2S0_DI             (0x03UL<<SYS_GPD_MFPL_PD4MFP_Pos) /* I2S0 data input pin. */ 
#define SYS_GPD_MFPL_PD4MFP_DMIC_DAT1           (0x04UL<<SYS_GPD_MFPL_PD4MFP_Pos) /* Digital microphone channel 1 data input pin. */  
#define SYS_GPD_MFPL_PD4MFP_TIM1                (0x05UL<<SYS_GPD_MFPL_PD4MFP_Pos) /* Timer1 event counter input / toggle output. */  
...
#define SYS_GPD_MFPL_PD5MFP_I2S0_DO             (0x03UL<<SYS_GPD_MFPL_PD5MFP_Pos) /* SPI1 Slave Select pin. */
#define SYS_GPD_MFPL_PD5MFP_DMIC_CLK0           (0x04UL<<SYS_GPD_MFPL_PD5MFP_Pos) /* Digital microphone channel 0 clock output pin. */ 
#define SYS_GPD_MFPL_PD5MFP_DPWM0_N             (0x05UL<<SYS_GPD_MFPL_PD5MFP_Pos) /* Audio DPWM right channel negative output pin. */ 
...
#define SYS_GPD_MFPL_PD6MFP_SPI1_I2SMCLK        (0x02UL<<SYS_GPD_MFPL_PD6MFP_Pos) /* SPI1 I2S master clock output pin */ 
#define SYS_GPD_MFPL_PD6MFP_I2S0_BCLK           (0x03UL<<SYS_GPD_MFPL_PD6MFP_Pos) /* I2S0 Bit Clock pin. */ 
#define SYS_GPD_MFPL_PD6MFP_DMIC_DAT0           (0x04UL<<SYS_GPD_MFPL_PD6MFP_Pos) /* Digital microphone channel 0 data input pin. */ 
#define SYS_GPD_MFPL_PD6MFP_DPWM0_P             (0x05UL<<SYS_GPD_MFPL_PD6MFP_Pos) /* Audio DPWM right channel positive output pin. */ 
...
#define SYS_GPD_MFPH_PD8MFP_T0                  (0x02UL<<SYS_GPD_MFPH_PD8MFP_Pos) /* Timer0 event counter input / toggle output. */
#define SYS_GPD_MFPH_PD8MFP_I2C1_SCL            (0x02UL<<SYS_GPD_MFPH_PD8MFP_Pos) /* I2C1 clock pin. */
#define SYS_GPD_MFPH_PD8MFP_I2C0_SCL            (0x02UL<<SYS_GPD_MFPH_PD8MFP_Pos) /* I2C0 clock pin. */
#define SYS_GPD_MFPH_PD8MFP_DPWM_SN             (0x02UL<<SYS_GPD_MFPH_PD8MFP_Pos) /* Audio DPWM sub-woofer channel negative output pin. */
...
#define SYS_GPD_MFPH_PD9MFP_I2C1_SDA            (0x03UL<<SYS_GPD_MFPH_PD9MFP_Pos) /* I2C1 data input/output pin. */ 
#define SYS_GPD_MFPH_PD9MFP_I2C0_SDA            (0x04UL<<SYS_GPD_MFPH_PD9MFP_Pos) /* I2C0 data input/output pin. */ 
#define SYS_GPD_MFPH_PD9MFP_DPWM_SP             (0x05UL<<SYS_GPD_MFPH_PD9MFP_Pos) /* Audio DPWM sub-woofer channel positive output pin. */ 
...
#define SYS_GPD_MFPH_PD13MFP_EADC0_CH10         (0x02UL<<SYS_GPD_MFPH_PD13MFP_Pos) /* EADC0 channel10 analog input. */ 
...
#define SYS_GPD_MFPH_PD14MFP_EADC0_CH11         (0x02UL<<SYS_GPD_MFPH_PD14MFP_Pos) /* EADC0 channel11 analog input. */ 
#define SYS_GPD_MFPH_PD14MFP_I2C0_SCL           (0x03UL<<SYS_GPD_MFPH_PD14MFP_Pos) /* I2C0 clock pin. */ 
#define SYS_GPD_MFPH_PD14MFP_UART0_TXD          (0x04UL<<SYS_GPD_MFPH_PD14MFP_Pos) /* UART0 data transmitter output pin. */
#define SYS_GPD_MFPH_PD14MFP_I2C1_SCL           (0x05UL<<SYS_GPD_MFPH_PD14MFP_Pos) /* I2C1 clock pin. */ 
...
#define SYS_GPD_MFPH_PD15MFP_EADC0_CH12         (0x02UL<<SYS_GPD_MFPH_PD15MFP_Pos) /* EADC0 channel12 analog input. */
#define SYS_GPD_MFPH_PD15MFP_I2C0_SDA           (0x03UL<<SYS_GPD_MFPH_PD15MFP_Pos) /* I2C0 data input/output pin. */
#define SYS_GPD_MFPH_PD15MFP_UART0_RXD          (0x04UL<<SYS_GPD_MFPH_PD15MFP_Pos) /* UART0 data receiver input pin. */ 
#define SYS_GPD_MFPH_PD15MFP_I2C1_SDA           (0x05UL<<SYS_GPD_MFPH_PD15MFP_Pos) /* I2C1 data input/output pin. */ 

/* Backward Compatible, do not use */
#define SYS_GPB_MFPH_PB13MFP_USBD_DN            (0x01UL<<SYS_GPB_MFPH_PB13MFP_Pos) 
#define SYS_GPB_MFPH_PB14MFP_USBD_DP            (0x01UL<<SYS_GPB_MFPH_PB14MFP_Pos)
#define SYS_GPC_MFPH_PC10MFP_TM_BRAKE0          (0x02UL<<SYS_GPC_MFPH_PC10MFP_Pos) /* Brake input pin 0 of PWM0. */ 
#define SYS_GPC_MFPH_PC11MFP_TM_BRAKE1          (0x02UL<<SYS_GPC_MFPH_PC11MFP_Pos) /* Brake input pin 1 of PWM0. */ 
/* Backward Compatible, do not use */
