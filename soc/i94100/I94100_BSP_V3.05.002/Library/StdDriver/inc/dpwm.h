...
/**
  ...
  * @param[in]  dpwm The base address of DPWM module
  * @return     None
  * @details    Note 1: To clear the FIFO, need to write FCLR (DPWM_CTL[29:28]) to 11b, and can read the EMPTY (DPWM_STATUS[1]) bit to make sure that the FIFO has been cleared.
								Note 2: This field is auto cleared by hardware.
  */
#define DPWM_CLEAR_FIFO(dpwm)   (dpwm->CTL |= DPWM_CTL_FCLR_Msk)
