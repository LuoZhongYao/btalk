...
/*---------------------------------------------------------------------------------------------------------*/
#define CLK_CLKSEL4_USBSEL_HIRC            (0x0UL<<CLK_CLKSEL4_USBSEL_Pos) /*!< Setting USB clock source as HIRC */
#define CLK_CLKSEL4_USBSEL_PLL             (0x1UL<<CLK_CLKSEL4_USBSEL_Pos) /*!< Setting USB clock source as PLL */
...
#define USBD_MODULE    (MODULE_APBCLK_ENC( 1)|MODULE_IP_EN_Pos_ENC(CLK_APBCLK0_USBDCKEN_Pos)|\
                        MODULE_CLKSEL_ENC(NA)|MODULE_CLKSEL_Msk_ENC( 1)|MODULE_CLKSEL_Pos_ENC(24)|\
