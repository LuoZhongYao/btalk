 ...
 * @brief    I94100 series UART driver header file
 *
 * @note
...
/** @addtogroup I94100_UART_EXPORTED_CONSTANTS UART Exported Constants
  @{
*/
...
/*@}*/ /* end of group I94100_UART_EXPORTED_CONSTANTS */
