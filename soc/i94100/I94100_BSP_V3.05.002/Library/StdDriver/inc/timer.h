 ...
 * @version  V1.00
 * $Revision: 1 $
 * $Date: 17/03/09 10:26a $
 * @brief    I94100 series Timer driver header file
 *
 * @note
...
/** @addtogroup I94100_TIMER_Driver TIMER Driver
  @{
*/

/** @addtogroup I94100_TIMER_EXPORTED_CONSTANTS TIMER Exported Constants
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
/*  TIMER Operation Mode, External Counter and Capture Mode Constant Definitions                           */
/*---------------------------------------------------------------------------------------------------------*/
#define TIMER_ONESHOT_MODE                      (0UL << TMR_CTL_OPMODE_Pos)      /*!< Timer working in one-shot mode */
#define TIMER_PERIODIC_MODE                     (1UL << TMR_CTL_OPMODE_Pos)      /*!< Timer working in periodic mode */
#define TIMER_TOGGLE_MODE                       (2UL << TMR_CTL_OPMODE_Pos)      /*!< Timer working in toggle-output mode */
#define TIMER_CONTINUOUS_MODE                   (3UL << TMR_CTL_OPMODE_Pos)      /*!< Timer working in continuous counting mode */
#define TIMER_TOUT_PIN_FROM_TX                  (0UL << TMR_CTL_TGLPINSEL_Pos)   /*!< Timer toggle-output pin is from Tx pin */
#define TIMER_TOUT_PIN_FROM_TX_EXT              (1UL << TMR_CTL_TGLPINSEL_Pos)   /*!< Timer toggle-output pin is from Tx_EXT pin */
#define TIMER_CAPTURE_FREE_COUNTING_MODE        (0UL << TMR_EXTCTL_CAPFUNCS_Pos) /*!< Timer capture event to get timer counter value */
#define TIMER_CAPTURE_COUNTER_RESET_MODE        (1UL << TMR_EXTCTL_CAPFUNCS_Pos) /*!< Timer capture event to reset timer counter */
#define TIMER_CAPTURE_FALLING_EDGE              (0UL << TMR_EXTCTL_CAPEDGE_Pos)  /*!< Falling edge detection to trigger timer capture */
#define TIMER_CAPTURE_RISING_EDGE               (1UL << TMR_EXTCTL_CAPEDGE_Pos)  /*!< Rising edge detection to trigger timer capture */
#define TIMER_CAPTURE_FALLING_AND_RISING_EDGE   (2UL << TMR_EXTCTL_CAPEDGE_Pos)  /*!< Both falling and rising edge detection to trigger timer capture */
#define TIMER_COUNTER_FALLING_EDGE              (0UL << TMR_EXTCTL_CNTPHASE_Pos) /*!< Counter increase on falling edge detection */
#define TIMER_COUNTER_RISING_EDGE               (1UL << TMR_EXTCTL_CNTPHASE_Pos) /*!< Counter increase on rising edge detection */
...
/* For new CAPEDGE mode */
#define TIMER_CAPEDGE_FALLING               (0UL << TMR_EXTCTL_CAPEDGE_Pos)
#define TIMER_CAPEDGE_RISING                (1UL << TMR_EXTCTL_CAPEDGE_Pos)
#define TIMER_CAPEDGE_BOTH_START_FALLING    (2UL << TMR_EXTCTL_CAPEDGE_Pos)
#define TIMER_CAPEDGE_BOTH_START_RISING     (3UL << TMR_EXTCTL_CAPEDGE_Pos)
#define TIMER_CAPEDGE_RESERVED0             (4UL << TMR_EXTCTL_CAPEDGE_Pos)
#define TIMER_CAPEDGE_RESERVED1             (5UL << TMR_EXTCTL_CAPEDGE_Pos)
#define TIMER_CAPEDGE_LOW_PERIOD            (6UL << TMR_EXTCTL_CAPEDGE_Pos)
#define TIMER_CAPEDGE_HIGH_PERIOD           (7UL << TMR_EXTCTL_CAPEDGE_Pos)

/* For new Trigger Source Selection */
#define TIMER_TRGSRC_TIMEOUT_EVENT      (0UL << TMR_TRGCTL_TRGSSEL_Pos)
#define TIMER_TRGSRC_CAPTURE_EVENT      (1UL << TMR_TRGCTL_TRGSSEL_Pos)
#define TIMER_TRG_TO_PWM                (TMR_TRGCTL_TRGPWM_Msk)
#define TIMER_TRG_TO_EADC               (TMR_TRGCTL_TRGEADC_Msk)
#define TIMER_TRG_TO_PDMA               (TMR_TRGCTL_TRGPDMA_Msk)
/*@}*/ /* end of group I94100_TIMER_EXPORTED_CONSTANTS */


/** @addtogroup I94100_TIMER_EXPORTED_FUNCTIONS TIMER Exported Functions
  @{
*/
...
/**
  ...
  */
__STATIC_INLINE void TIMER_EnableWakeup(TMR_T *timer)
{
    timer->CTL |= TMR_CTL_WKEN_Msk;
}
...
/**
  ...
  */
__STATIC_INLINE void TIMER_DisableWakeup(TMR_T *timer)
{
    timer->CTL &= ~TMR_CTL_WKEN_Msk;
}
...
/**
  ...
  */
__STATIC_INLINE void TIMER_EnableCaptureDebounce(TMR_T *timer)
{
    timer->EXTCTL |= TMR_EXTCTL_CAPDBEN_Msk;
}
...
/**
  ...
  */
__STATIC_INLINE void TIMER_DisableCaptureDebounce(TMR_T *timer)
{
    timer->EXTCTL &= ~TMR_EXTCTL_CAPDBEN_Msk;
}
...
/**
  ...
  */
__STATIC_INLINE void TIMER_EnableEventCounterDebounce(TMR_T *timer)
{
    timer->EXTCTL |= TMR_EXTCTL_CNTDBEN_Msk;
}
...
/**
  ...
  */
__STATIC_INLINE void TIMER_DisableEventCounterDebounce(TMR_T *timer)
{
    timer->EXTCTL &= ~TMR_EXTCTL_CNTDBEN_Msk;
}
...
/**
  ...
  */
__STATIC_INLINE void TIMER_EnableCaptureInt(TMR_T *timer)
{
    timer->EXTCTL |= TMR_EXTCTL_CAPIEN_Msk;
}
...
/**
  ...
  */
__STATIC_INLINE void TIMER_DisableCaptureInt(TMR_T *timer)
{
    timer->EXTCTL &= ~TMR_EXTCTL_CAPIEN_Msk;
}
...
{
    timer->INTSTS = (timer->INTSTS & ~TMR_INTSTS_TWKF_Msk) | TMR_INTSTS_TIF_Msk;
}
...
/**
  ...
  */
__STATIC_INLINE uint32_t TIMER_GetCaptureIntFlag(TMR_T *timer)
{
...
/**
  ...
  */
__STATIC_INLINE void TIMER_ClearCaptureIntFlag(TMR_T *timer)
{
    timer->EINTSTS = TMR_EINTSTS_CAPIF_Msk;
}
...
/**
  ...
  */
__STATIC_INLINE uint32_t TIMER_GetWakeupFlag(TMR_T *timer)
{
    return ((timer->INTSTS & TMR_INTSTS_TWKF_Msk) ? 1 : 0);
}
...
/**
  ...
  */
__STATIC_INLINE void TIMER_ClearWakeupFlag(TMR_T *timer)
{
    timer->INTSTS = (timer->INTSTS & ~TMR_INTSTS_TIF_Msk) | TMR_INTSTS_TWKF_Msk;
}
...
/**
  ...
  */
__STATIC_INLINE uint32_t TIMER_GetCaptureData(TMR_T *timer)
{
    return timer->CAP;
}
...
void TIMER_EnableCapture(TMR_T *timer, uint32_t u32CapMode, uint32_t u32Edge);
void TIMER_DisableCapture(TMR_T *timer);
void TIMER_EnableEventCounter(TMR_T *timer, uint32_t u32Edge);
void TIMER_DisableEventCounter(TMR_T *timer);
uint32_t TIMER_GetModuleClock(TMR_T *timer);

/*@}*/ /* end of group I94100_TIMER_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group I94100_TIMER_Driver */
