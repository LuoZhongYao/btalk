 ...
 * @version  V1.00
 * $Revision: 1 $
 * $Date: 17/03/13 10:26a $
 * @brief    I94100 series PWM driver source file
 *
 * @note
...
/**
 * @brief Enable rising capture reload of selected channel(s)
 * @param[in] pwm The pointer of the specified PWM module
 *                - PWM0 : PWM Group 0
 *                - PWM1 : PWM Group 1
 * @param[in] u32ChannelMask Combination of enabled channels. Each bit corresponds to a channel.
 *                           Bit 0 is channel 0, bit 1 is channel 1...
 * @return None
 * @details This function is used to enable rising capture reload of selected channel(s).
 */
void PWM_EnableRisingCaptureReload(PWM_T *pwm, uint32_t u32ChannelMask)
{
    (pwm)->CAPCTL |= (u32ChannelMask << PWM_CAPCTL_RCRLDEN0_Pos);
}

/**
 * @brief Disable rising capture reload of selected channel(s)
 * @param[in] pwm The pointer of the specified PWM module
 *                - PWM0 : PWM Group 0
 *                - PWM1 : PWM Group 1
 * @param[in] u32ChannelMask Combination of enabled channels. Each bit corresponds to a channel.
 *                           Bit 0 is channel 0, bit 1 is channel 1...
 * @return None
 * @details This function is used to disable rising capture reload of selected channel(s).
 */
...
/**
 * @brief Enable falling capture reload of selected channel(s)
 * @param[in] pwm The pointer of the specified PWM module
 *                - PWM0 : PWM Group 0
 *                - PWM1 : PWM Group 1
 * @param[in] u32ChannelMask Combination of enabled channels. Each bit corresponds to a channel.
 *                           Bit 0 is channel 0, bit 1 is channel 1...
 * @return None
 * @details This function is used to enable falling capture reload of selected channel(s).
 */
void PWM_EnableFallingCaptureReload(PWM_T *pwm, uint32_t u32ChannelMask)
{
    (pwm)->CAPCTL |= (u32ChannelMask << PWM_CAPCTL_FCRLDEN0_Pos);
}

/**
 * @brief Disable falling capture reload of selected channel(s)
 * @param[in] pwm The pointer of the specified PWM module
 *                - PWM0 : PWM Group 0
 *                - PWM1 : PWM Group 1
 * @param[in] u32ChannelMask Combination of enabled channels. Each bit corresponds to a channel.
 *                           Bit 0 is channel 0, bit 1 is channel 1...
 * @return None
 * @details This function is used to disable falling capture reload of selected channel(s).
 */
...
{
  uint32_t u32Temp = (pwm)->CAPIF;
  
    return (((((pwm)->CAPIF & (PWM_CAPIF_CFLIF0_Msk << u32ChannelNum)) ? 1 : 0) << 1) | \
            ((u32Temp & (PWM_CAPIF_CRLIF0_Msk << u32ChannelNum)) ? 1 : 0));
}
/**
