					...
					{
                        {
                         ...
                         USBD_SetStall(0);
						 DBG_PRINTF("Get_CUR USBD_SetStall(0): %08X\n", UAC_REC.g_usbd_PlaySampleRate); 
                    }
...
//                                #endif
                            ...
                            {
//                                #if (UAC_MIC_DEBUG)
//                                DBG_PRINTF("VOLUME_CONTROL_3CH = %x\n", buf[2]);
//                                #endif
                            ...
                            {
//                                #if (UAC_MIC_DEBUG)
//                                DBG_PRINTF("VOLUME_CONTROL_4CH = %x\n", buf[2]);
//                                #endif
