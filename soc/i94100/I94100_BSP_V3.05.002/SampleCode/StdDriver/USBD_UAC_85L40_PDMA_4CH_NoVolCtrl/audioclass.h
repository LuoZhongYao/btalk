...
#define USBD_PID     0x1205

/* Define EP maximum packet size */
#define EP0_MAX_PKT_SIZE    8     
#define EP1_MAX_PKT_SIZE    EP0_MAX_PKT_SIZE
#define EP2_MAX_PKT_SIZE    (REC_RATE*UAC_REC_CHANNEL_1CH*3/1000)			
#define EP3_MAX_PKT_SIZE    (REC_RATE*UAC_REC_CHANNEL_2CH*3/1000)			
#define EP4_MAX_PKT_SIZE    (REC_RATE*UAC_REC_CHANNEL_3CH*3/1000)			
#define EP5_MAX_PKT_SIZE    (REC_RATE*UAC_REC_CHANNEL_4CH*3/1000)			
