...
const uint8_t g_u8PrinterAndHIDTrans_DeviceReportDescriptor[] = {
...
const uint8_t g_u8PrinterAndHIDTrans_DeviceDescriptor[] = {
    LEN_DEVICE,     /* bLength */
...
uint8_t g_u8PrinterAndHIDTrans_ConfigDescriptor[] = {
    LEN_CONFIG,     /* bLength              */
    ...
    sizeof(g_u8PrinterAndHIDTrans_DeviceReportDescriptor) & 0x00FF,
    (sizeof(g_u8PrinterAndHIDTrans_DeviceReportDescriptor) & 0xFF00) >> 8,
...
uint8_t g_u8PrinterAndHIDTrans_StringLang[4] = {
    4,              /* bLength */
...
uint8_t g_u8PrinterAndHIDTrans_VendorStringDesc[] = {
    16,
    DESC_STRING,
...
uint8_t g_u8PrinterAndHIDTrans_ProductStringDesc[] = {
    22,             /* bLength          */
    DESC_STRING,    /* bDescriptorType  */
...
/*!<USB BOS Descriptor */
const uint8_t g_u8PrinterAndHIDTrans_BOSDescriptor[] = {
    LEN_BOS,        /* bLength */
...
uint8_t *g_pu8PrinterAndHIDTrans_UsbString[4] = {
    g_u8PrinterAndHIDTrans_StringLang,
    g_u8PrinterAndHIDTrans_VendorStringDesc,
    g_u8PrinterAndHIDTrans_ProductStringDesc,
    NULL,
};

uint8_t *gu8UsbHidReport[3] = {
    NULL,
    (uint8_t*)g_u8PrinterAndHIDTrans_DeviceReportDescriptor,
    NULL,
};

uint32_t gu32UsbHidReportLen[3] = {
    0,
    sizeof(g_u8PrinterAndHIDTrans_DeviceReportDescriptor),
    0,
};

uint32_t gu32ConfigHidDescIdx[3] = {
    0,
    (sizeof(g_u8PrinterAndHIDTrans_ConfigDescriptor) - LEN_HID - (2*LEN_ENDPOINT)),
    0,
};

const S_USBD_INFO_T gsInfo = {
    (uint8_t *)g_u8PrinterAndHIDTrans_DeviceDescriptor,
    (uint8_t *)g_u8PrinterAndHIDTrans_ConfigDescriptor,
    (const uint8_t **)g_pu8PrinterAndHIDTrans_UsbString,
    (const uint8_t **)gu8UsbHidReport,
    (uint8_t *)g_u8PrinterAndHIDTrans_BOSDescriptor,
