...
Purpose:
---------------------------------------------------------------------------------------------------------
	Demonstrate how to implement a record and playback device by using NAU85L40 as microphones, DPWM to drive speakers and I2S to transfer data between I94100 and NAU85L40. PDMA is implemented for data transfer from RAM to DPWM.
	(1)	Using I2C1 to set parameters to NAU85L40.
	(2)	Using I2S0 to receive audio data from NAU85L40.
	(3)	Using PDMA Scatter-and-Gather mode to transfer data from SRAM(software buffer) to DPWM.
---------------------------------------------------------------------------------------------------------
Operation:
---------------------------------------------------------------------------------------------------------
