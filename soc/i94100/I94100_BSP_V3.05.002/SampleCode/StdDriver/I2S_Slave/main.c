...
int32_t main(void)
{
	...
	I2S0_Slave_Initiate((S_BUFCTRL*)(&sInBufCtrl),(S_BUFCTRL*)(&sOutBufCtrl));
	...
	printf("Stereo mode\n");
	printf("I2S format\n");
	printf("TX value: 0x1B1B0000, 0x1B1B0001, ..., 0x1B1B00FF\n");
	...
	while(1)
	{
		...
		{
			BUFCTRL_READ((&sInBufCtrl), &u32i);
			BUFCTRL_WRITE((&sOutBufCtrl), (u32i-0x5A0000));
		}
	}
}
...
void I2S0_Slave_Initiate(S_BUFCTRL* psInBufCtrl,S_BUFCTRL* psOutBufCtrl)
{
	...
	I2S_Open(I2S0, I2S_SLAVE, 0, I2S_DATABIT_32, I2S_TDMCHNUM_2CH, I2S_STEREO, I2S_FORMAT_I2S);
	// I2S0 Configuration
	...
	// Enable interrupt.
	I2S_ENABLE_INT(I2S0, I2S_RXTH_INT_MASK|I2S_TXTH_INT_MASK);
	// Enable I2S's NVIC. 
