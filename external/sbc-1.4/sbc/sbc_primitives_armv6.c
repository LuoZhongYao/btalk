...
static void __attribute__((naked)) sbc_analyze_four_armv6(int16_t *in, int32_t *out, const FIXED_T *consts)
{
...
#define sbc_analyze_four(in, out, consts) sbc_analyze_four_armv6(in, out, consts)

static void __attribute__((naked)) sbc_analyze_eight_armv6(int16_t *in, int32_t *out, const FIXED_T *consts)
{
	/* r0 = in, r1 = out, r2 = consts */
	__asm__ volatile (
		"push   {r1, r4-r7, lr}\n"
...
#define sbc_analyze_eight(in, out, consts) sbc_analyze_eight_armv6(in, out, consts)
